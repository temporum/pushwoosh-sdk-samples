...
public class GCMExtension implements FREExtension {
	...
	private static String TAG = "gcmExtension";
	...
	public FREContext createContext(String extId) {
		Log.d(TAG, "GCMExtension.createContext extId: " + extId);
		return context = new GCMExtensionContext();
	}
	 ...
	 */
	public void dispose() {
		Log.d(TAG, "GCMExtension.dispose");
		context = null;
	}
	...
	public void initialize() {
		Log.d(TAG, "GCMExtension.initialize");
	}
}
